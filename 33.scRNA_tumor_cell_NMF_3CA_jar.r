...
# jaccard plot ----------------------------------------------------------------
X_order <- c("IMP32","IMP31","IMP10","IMP28","IMP35","IMP12","IMP29","IMP16","IMP17","IMP26","IMP15",
             "IMP22","IMP33","IMP24","IMP7","IMP9","IMP44","IMP21","IMP27","IMP37","IMP39","IMP38",
             "IMP14","IMP34","IMP4","IMP48","IMP49","IMP45","IMP42","IMP40","IMP5","IMP23","IMP20",
             "IMP18",
             "IMP1","IMP8","IMP11","IMP13","IMP19","IMP25","IMP30","IMP36","IMP41","IMP43","IMP46","IMP47","IMP50"
             )
...
function_plot(filename_prefix = str_glue("{output_dir}/MP_cor_text"), width = 520, height = 500)
